...
int main() {
	...
	*pI = 234;  
	...
	//can change pointer but cannot change the value
	const int* pcI;
	pcI = &joe;  
	//*pcI = 234;  
	pcI = &sal;  
	...
	//can change value but cannot change pointer
	//also cant point to const int
	//int* const cpi;
	int* const cpi(&joe);
	//int* const cpi(&sal);
	//cpi = &joe;  
	*cpi = 123;  
	...
	//cannot change value or the object it points to
	...
	*pDyn = 17;
	...
	amplifier2.attachSpeakers(speaker1);
